...
import 'package:pencatatan_kinerja_ob/supervisor_pages/spv_oh_detail.dart';
import 'package:pencatatan_kinerja_ob/view_pdf/view_pdf.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:http/http.dart' as http;

class SPVOHList extends StatefulWidget {
  const SPVOHList({super.key});

  @override
  State<SPVOHList> createState() => _SPVOHList();
}

class _SPVOHList extends State<SPVOHList> {
                    ...
                    child: InkWell(
                      ...
                      onTap: (){
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => SPVOHDetail(officeHelperID: result[index]['oh_id']),
                          ),
                        );
                      },
                      child: Container(
