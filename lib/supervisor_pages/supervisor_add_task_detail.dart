...
class SupervisorAddTaskDetail extends StatefulWidget {
  const SupervisorAddTaskDetail({super.key, required this.reqID});

  final String reqID;

  @override
  State<SupervisorAddTaskDetail> createState() => _SupervisorAddTaskDetail();
}

class _SupervisorAddTaskDetail extends State<SupervisorAddTaskDetail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: Future.wait([getData(), getAssignedOH()]),
